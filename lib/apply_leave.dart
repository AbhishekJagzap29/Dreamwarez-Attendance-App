...
//           _leaveRequests = requests
//               .where(
//                 (request) => request.employeeName == widget.currentUserName,
//               )
//               .toList();
//         }
...
//   Widget _buildLeaveStatsPieChart() {
...
//                       value: stats['submitted']!.toDouble(),
//                       title:
//                           'Submitted\n${((stats['submitted']! / total) * 100).toStringAsFixed(1)}%',
//                       radius: 70,
...
//           : Column(
//               children: [
//                 if (widget.userRole == 'admin') _buildLeaveStatsPieChart(),
